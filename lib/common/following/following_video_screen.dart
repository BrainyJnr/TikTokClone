...
import 'controller/following_video_controller.dart';

class FollowingVideoScreen extends StatefulWidget {
  @override
  _FollowingVideoScreenState createState() => _FollowingVideoScreenState();
}
...
class _FollowingVideoScreenState extends State<FollowingVideoScreen> {
  ...
  void initState() {
    ...
    _pageController = PageController(
      initialPage: controllerFollowingVideos.currentVideoIndex.value,
      viewportFraction: 1,
    );
    ...
    _pageController.addListener(() {
      if (_pageController.page != null) {
        controllerFollowingVideos.currentVideoIndex.value =
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Video PageView
          Obx(() {
            if (controllerFollowingVideos.followingAllVideoList.isEmpty) {
              return Center(child: Text("No videos from your followed users."));
            } else {
              return PageView.builder(
                itemCount:
                    controllerFollowingVideos.followingAllVideoList.length,
                controller: _pageController,
                scrollDirection: Axis.vertical,
                itemBuilder: (context, index) {
                  final eachVideoInfo =
                      controllerFollowingVideos.followingAllVideoList[index];
